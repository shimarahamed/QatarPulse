      ...
      <CardContent>
        <TooltipProvider>
            ...
            <TableBody>
                ...
                {claims?.map((claim) => {
                  const isInvalidClaim = !claim.businessId || claim.businessId === 'unknown';
                  return (
                  <TableRow key={claim.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                            ...
                            <Tooltip>
                                ...
                                <TooltipContent>
                                <p>Invalid Business ID. This claim cannot be approved.</p>
                                </TooltipContent>
                            </Tooltip>
                            )}
                        </div>
                      ...
                      <DropdownMenu>
                          ...
                          <DropdownMenuItem
                              ...
                              disabled={isInvalidClaim || isUpdating === claim.id || claim.status !== 'pending'}
                          >
